...
| Компонент |Описание                        | Сложность |Размер|
|-----------|--------------------------------|--|--|
|Verifier|Выполняет аутентификацию критических устройств, проверяет подпись переданных данных| S | S |
|MainHub|Получает данные от критических девайсов и передаёт в MainStorage| S | S |
|MainStorage|Хранит последние данные критических девайсов| S | S |
