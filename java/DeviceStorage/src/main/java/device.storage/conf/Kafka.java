...
public class Kafka {
    ...
    public KafkaTemplate<String, MessageAuthWithPassword> allAcksKafkaTemplate() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageAuth>
